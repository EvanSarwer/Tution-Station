<?php 
	...
	require_once "models/db_config.php";
			...
			if(isset($_POST["add_student"])){
				...
				if(!$hasError){
					...
					if(checkUsername($uname)){
						...
						insertStudent($name,$uname,$instituate,$password,$email,$phone,$address,$dob,$gender,$medium,$class);
			...
			function insertStudent($name,$uname,$instituate,$password,$email,$phone,$address,$dob,$gender,$medium,$class){
				$query= "insert into users values(NULL,'$name','$uname','$instituate','$password','$email','$phone','$address','$dob','$gender','$medium','$class','Student','','')";
			...
			if(isset($_POST["update_student"])){
				...
				if(!$hasError){
					...
					updateStudent($id,$name,$uname,$instituate,$password,$email,$phone,$address,$dob,$gender,$medium,$class);
					$err_message1="Student Updated Successfully";
			...
			function updateStudent($id,$name,$uname,$instituate,$password,$email,$phone,$address,$dob,$gender,$medium,$class){
			...
			function searchStudent($key){
				$query = "select id,name from users where area like '%$key%'  and type like 'Student'";
				$result=get($query);
				return $result;
			}
