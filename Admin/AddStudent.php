...
?> 	
	    ...
	    <fieldset style="width:650px;border:solid 2px" >
			<legend> <h1>Add Student Form</h1></legend>
			<form action="" method="post" onsubmit="return validate()">
				<table style="margin-left:5px">
					...
					<tr>
						<td align="center" colspan="2"><input type="submit" name="add_student" value="Add Student"></td>
					</tr>
		...
		<script>
			...
			function checkUsername(control){
				...
				xhttp.open("GET","checkUsernameStudent.php?uname="+username,true);
				xhttp.send();
			}
