...
?>
		...
		<fieldset style="width:650px;border:solid 2px" >
			<legend> <h1>Edit & Update Student Form</h1></legend>
			<form action="" method="post">
				<table style="margin-left:5px">
					...
					<tr>
						<td><input  type="hidden" value="<?php echo $student["id"];?>" name="id"></td>
					</tr>
					
				    <tr>
						<td align="right"><span>Student Name </span></td>
						
						<td>:<input size="29" type="text" value="<?php echo $student["name"];?>" name="name">
						<span style="color:red"><?php echo $err_name;?></span></td>
					</tr>
					<tr>
						<td align="right"><span>User Name </span></td>
						<td>:<input size="29" type="text" value="<?php echo $student["username"];?>" name="uname">
						<span style="color:red"><?php echo $err_uname;?></span></td>
						
					</tr>
					<tr>
						<td align="right"><span> Name of the Institution</span></td>
						<td>:<input size="29" type="text" value="<?php echo $student["institution"];?>" name="instituate">
						<span style="color:red"><?php echo $err_instituate;?></span></td>
						
					</tr>
					<tr>
						<td align="right"><span>Password </span></td>
						<td>:<input size="29" type="password" value="<?php echo $student["password"];?>" name="pass">
						<span style="color:red"><?php echo $err_password;?></span></td>
					</tr>
					<tr>
						<td align="right"><span>Confirm Password </span></td>
						<td>:<input size="29" type="password" value="<?php echo $student["password"];?>" name="cpass">
						<span style="color:red"><?php echo $err_confirmPassword;?></span></td>
					</tr>
					<tr>
						<td align="right"><span>Email </span></td>
						<td>:<input size="29" type="text" value="<?php echo $student["email"];?>" name="email">
						<span style="color:red"><?php echo $err_email;?></span></td>
						
					</tr>
					<tr>
						<td align="right"><span>Phone </span></td>
						<td>:<input style="margin-left:2.3px" size="29" type="text" placeholder="Number" value="<?php echo $student["phone"];?>" name="number">
						<span style="color:red"><?php echo $err_phone;?></span></td>
						
					</tr>
					<tr>
						<td align="right" style="vertical-align: top" ><span>Address </span></td>
						<td>:<input size="29" type="text" placeholder="Address" value="<?php echo $student["address"];?>" name="street">
					...
					<tr>
						...
						<td>:<input size="29" type="text" placeholder="Address" value="<?php echo $student["dob"];?>" name="dob">
					...
					<tr>
						...
						<td>:
							<select  name="medium">
								<option ><?php echo $student["medium"];?></option>
					...
					<tr><td align="right"><span>Select Class </span></td>
						<td>:
							<select  name="class">
								<option ><?php echo $student["class"];?></option>
								<option>  Kg*  </option>
					...
					<tr>
						<td align="center" colspan="2"><input type="submit" name="update_student" value="Update Student"></td>
					</tr>
